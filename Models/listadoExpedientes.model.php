...
$columns = ['idSol', 'tipExpJud', 'materia', 'demandante', 'demandado', 'causante', 'juzgado', 'nomSec', 'Lugar', 'dia', 'mes', 'anio', 'obs'];
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td>' . $row['tipExpJud'] . '</td>';
        $output['data'] .= '<td>' . $row['materia'] . '</td>';
        $output['data'] .= '<td>' . $row['demandante'] . '</td>';
        $output['data'] .= '<td>' . $row['demandado'] . '</td>';
        $output['data'] .= '<td>' . $row['causante'] . '</td>';
        $output['data'] .= '<td>' . $row['juzgado'] . '</td>';
        $output['data'] .= '<td>' . $row['nomSec'] . '</td>';
        $output['data'] .= '<td>' . $row['Lugar'] . '</td>';
    ...
    $output['data'] .= '<tr>';
    $output['data'] .= '<td colspan="15">Sin resultados</td>';
    $output['data'] .= '</tr>';
}
