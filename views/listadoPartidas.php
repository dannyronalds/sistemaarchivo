...
<body style="background: url('../views/img/partidas.jpg') no-repeat center center fixed; background-size: cover;">
...
<body>
                ...
                <div class="col">
                    <table class="table table-sm table-bordered table-striped">
                        <thead>
                            ...
                            <th class="sort asc">tipPar</th>
                            <th class="sort asc">nombre1</th>
                            <th class="sort asc">nombre2</th>
                            <th class="sort asc">dia</th>
                            <th class="sort asc">mes</th>
                            <th class="sort asc">anio</th>
                            <th class="sort asc">muni</th>
                            <th class="sort asc">obs</th>
                        </thead>
                        <tbody id="content">
    ...
    <script>
        ...
        function getData() {
            ...
            let url = "../Models/listadoPartidas.model.php";
