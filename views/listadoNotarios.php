...
<body style="background: url('../views/img/diadederecho.jpg') no-repeat center center fixed; background-size: cover;">
 
<body>
    <main>
        <div class="container py-4 text-center">
            <h2>LISTA DE NOTARIOS</h2>
                ...
                <div class="col">
                    <table class="table table-sm table-bordered table-striped">
                        <thead>
                            ...
                            <th class="sort asc">APELLIDO1</th>
                            <th class="sort asc">APELLIDO2</th>
                            <th class="sort asc">FECHA INICIO</th>
                            <th class="sort asc">FECHA FIN</th>
                            <th class="sort asc">PROVINCIA</th>
    ...
    <script>
        ...
        function getData() {
            ...
            let url = "../Models/listadonotarios.model.php";
